...
import page3 from '../user/Precription';
import page4 from '../user/chatscreen';
import page5 from '../user/page5';
  ...
  useEffect(() => {
    ...
    return (
      <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name={"prescription"} component={page3}  options={{
           tabBarIcon: ({focused}) =>(
               <View style={{
                 position:'absolute',
               }}>
                  <FontAwesome5 name="file-prescription" size={20}  color={focused ? 'red' : 'gray'}></FontAwesome5>
               </View>
           )
            }}></Tab.Screen>
        <Tab.Screen name={"message"} component={page4}  options={{
           tabBarIcon: ({focused}) =>(
               <View style={{
                 position:'absolute',
               }}>
