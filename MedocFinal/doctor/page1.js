...
export default function page4({ navigation }) {
  const pressHandler20 =() =>{
    navigation.navigate('Docappoint');
  }  
    ...
    return (
      <View style={styles.container}>
        ...
        <Image style={styles.img} source={require('../assets/appointment.png')} />
             ...
             <Text style={styles.buttontext4}>Find your Appointment here</Text>
           </TouchableOpacity>
           ...
           <Image style={styles.img} source={require('../assets/hospital.png')} />
             <Text style={styles.buttontext}>Patient log</Text>
             <Text style={styles.buttontext4}>Find patient Details</Text>
           </TouchableOpacity>
