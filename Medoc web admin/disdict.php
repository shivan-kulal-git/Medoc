        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="adddictionary.php" class="btn btn-neutral"><i class="ni ni-fat-add"></i>
                      <span>Add to Dictionary</span></a>
            </div>
              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody class="list">
                  <?php
                        ...
                        $qry = mysqli_query($con,"SELECT * FROM `disdictionary`");
                        while($result = mysqli_fetch_array($qry))
                        {
                        ?>
                  <tr class="odd gradeX">
                    <td>
                      <?php echo $result['Dis_name']; ?>
                        
                      
                    </td>
                    <td>
                      <?php echo $result['Dis_defination']; ?>
                    </td>
                    <td>
                      <?php echo $result['Symptoms']; ?>
                    </td>
                    <td>
                     <?php echo $result['Causes']; ?>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="editdictionary.php?id=<?php echo $result['disid']; ?>">Edit</a>
                          <a class="dropdown-item" href="deletedictionary?id=<?php echo $result['disid']; ?> "onclick='return checkdelete()'>Delete</a>
