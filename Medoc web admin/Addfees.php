        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link active" href="Afees.php">
                <i class="ni ni-bullet-list-67 text-default"></i>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Add Fees</h6>
            ...
            <div class="card-body">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="aid">Appointment ID</label>
                        <input type="text" id="aid" name="aid" class="form-control" placeholder="Appointment ID" required="">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                 ...
                 <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="famt">Fees Amount</label>
                        <input type="text" id="famt" name="famt" class="form-control" placeholder="Fees Amount" required="">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="fstat">Fees Status</label>
                        <input type="text" id="fstat" name="fstat" class="form-control" placeholder="Fees Status" required="">
                      </div>
                    </div>
                  </div>
                 </div>
              ...
              <div class="d-flex justify-content-between">
               <input type="submit" name="addp" class="btn btn-sm btn-info  mr-4 " value="Add">
                <a href="Afees.php" class="btn btn-sm btn-default float-right">Back</a>
              </div>
            </div>
        ...
        if(isset($_POST['addp']))
        {
            ...
            $sql = mysqli_query($con,"INSERT INTO `fees`( `Aid`, `Date`, `F_amount`, `F_status`) VALUES ('$aid','$date','$famt','$fstat')");
              if($sql == true)
            {
                echo'
                <script>
