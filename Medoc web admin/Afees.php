          ...
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
             ...
             <div class="col-lg-6 col-5 text-right">
              <a href="Addfees.php" class="btn btn-neutral"><i class="ni ni-fat-add"></i>
                      <span>Add Fees</span></a>
            </div>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Fees list</h6>
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover">
                 <thead>
                        ...
                        $qry = mysqli_query($con,"SELECT * FROM `fees`");
                        ...
                        ?>
                                        ...
                                        <tr class="odd gradeX">
                                           <td><?php echo $result['Fid']; ?></td>
                                            ...
                                            <td><?php echo $result['F_amount']; ?></td>
                                           
                                            <td><?php echo $result['F_status']; ?></td>
