        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="AddAppointment.php" class="btn btn-neutral"><i class="ni ni-fat-add"></i>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Appointment list</h6>
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover">
                 <thead>
                        ...
                        $qry = mysqli_query($con,"SELECT * FROM `appoinment`");
                        ...
                        ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $result['A_status']; ?></td>
