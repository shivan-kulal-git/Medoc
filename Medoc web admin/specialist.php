        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="addspecialist.php" class="btn btn-neutral"><i class="ni ni-fat-add"></i>
                      <span>Add Specialist</span></a>
            </div>
              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody class="list">
                  <?php
                        ...
                        $qry = mysqli_query($con,"SELECT * FROM `specialist`");
                        while($result = mysqli_fetch_array($qry))
                        {
                        ?>
                  <tr class="odd gradeX">
                    <td>
                      <?php echo $result['Specialties']; ?>
                        
                      
                    </td>
                    <td>
                      <?php echo $result['Experties']; ?>
                    </td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="editspecialist.php?id=<?php echo $result['Sid']; ?>">Edit</a>
                          <a class="dropdown-item" href="deletespecialist.php?id=<?php echo $result['Sid']; ?> "onclick='return checkdelete()'>Delete</a>
