            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Precription</a></li>
                  <li class="breadcrumb-item active" aria-current="page">list</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="addprecreption.php" class="btn btn-neutral"><i class="ni ni-fat-add"></i>
                      <span>Add precreption</span></a>
            </div>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">precreption list</h6>
              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody class="list">
                  <?php
                        ...
                        $qry = mysqli_query($con,"SELECT * FROM `prescription`");
                        while($result = mysqli_fetch_array($qry))
                        {
                        ?>
                  <tr class="odd gradeX">
                    <td>
                      <?php echo $result['PSid']; ?>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="editprecreption.php?id=<?php echo $result['PSid']; ?>">Edit</a>
                          <a class="dropdown-item" href="deleteprecreption.php?id=<?php echo $result['PSid']; ?> "onclick='return checkdelete()'>Delete</a>
