...
<body>
  ...
  <div class="main-content" id="panel">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Edit Dictionary</li>
                </ol>
              </nav>
            </div>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Edit Dictionary</h6>
         ...
         $con = mysqli_connect("localhost","root","","medoc");
            $qry = mysqli_query($con,"SELECT * FROM `disdictionary` WHERE disid='$id'");
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input required="" type="text" id="Dis_name" name="Dis_name" class="form-control" placeholder="Disease Name" value="<?php echo $result['Dis_name'] ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input required="" type="text" id="Symptoms" name="Symptoms" class="form-control" placeholder="Symptoms" value="<?php echo $result['Symptoms'] ?>" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input required="" type="text" id="Causes" name="Causes" class="form-control" placeholder="Causes" value="<?php echo $result['Causes'] ?>">
                      </div>
                    </div>
                  </div>
                   <div class="pl-lg-4">
                    ...
                    <textarea rows="4" id="Dis_defination" name="Dis_defination" class="form-control" placeholder="Disease Defination" required="" value=""><?php echo $result['Dis_defination'] ?></textarea>
                  </div>
                </div>
                </div>
    ...
    if(isset($_POST['add']))
    {
      ...
      $sql = mysqli_query($con,"UPDATE `disdictionary` SET `Dis_name`='$Dis_name',`Dis_defination`='$Dis_defination',`Symptoms`='$Symptoms',`Causes`='$Causes' WHERE disid='$disid'") or die(mysqli_error($con));
      if($sql == true)
      {
        echo'
        <script>
