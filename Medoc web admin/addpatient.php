    ...
    <div class="container-fluid mt--6">
      <div class="row">
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Add Patient</h6>
            ...
            <div class="card-body">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="patname">Patient Name</label>
                        <input type="text" id="patname" name="patname" class="form-control" placeholder="Patient Name" required="">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                 ...
                 <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="pno">Phone no</label>
                        <input type="text" id="pno" name="pno" class="form-control" placeholder="Phone no" required="">
                      </div>
                    </div>
                  </div>
                 </div>
                 <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="addre">Address</label>
                        <input type="text" id="addre" name="addre" class="form-control" placeholder="Address" required="">
                      </div>
                    </div>
              ...
              <div class="d-flex justify-content-between">
               <input type="submit" name="addp" class="btn btn-sm btn-info  mr-4 " value="Add">
                <a href="patient.php" class="btn btn-sm btn-default float-right">Back</a>
              </div>
            </div>
        ...
        if(isset($_POST['addp']))
        {
            ...
            $sql = mysqli_query($con,"INSERT INTO `patientlist`( `Pname`,`Gender`,`Age`,`Phone_no`,`address`) VALUES ('$patname','$gender','$age','$pno','$addre')");
              if($sql == true)
            {
                echo'
                <script>
