    ...
    <div class="container-fluid mt--6">
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="spec">Specialist</label>
                        <input required="" type="text" id="spec" name="spec" class="form-control" placeholder="Specialist">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="expe">Experties</label>
                        <input required="" type="text" id="expe" name="expe" class="form-control" placeholder="Experties">
                      </div>
                    </div>
                  </div>
                 </div>
              ...
              <div class="d-flex justify-content-between">
               <input type="submit" name="addsp" class="btn btn-sm btn-info  mr-4 " value="Add">
        ...
        if(isset($_POST['addsp']))
        {
            ...
            $sql = mysqli_query($con,"INSERT INTO `specialist`( `Specialties`, `Experties`) VALUES ('$spec','$expe')");
              if($sql == true)
            {
                echo'
                <script>
            ...
            else
            {
                echo'
                        <script>
                        alert("Error");
                        window.location="addspecialist.php";
                        </script>
                        ';
            }
        }
