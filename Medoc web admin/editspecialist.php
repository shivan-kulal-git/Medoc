...
<body>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="specialist.php">
  ...
  <div class="main-content" id="panel">
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Add Specialist</h6>
         ...
         $con = mysqli_connect("localhost","root","","medoc");
            $qry = mysqli_query($con,"SELECT * FROM `specialist` WHERE sid='$id'");
          ...
          ?>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <label class="form-control-label" for="Special">Specialist</label>
                        <input required="" type="text" id="Special" name="Special" class="form-control" placeholder="Specialties" value="<?php echo $result['Specialties'] ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="Experties">Experties</label>
                        <input required="" type="text" id="Experties" name="Experties" class="form-control" placeholder="Experties" value="<?php echo $result['Experties'] ?>">
                      </div>
                    </div>
                  </div>
                  </div>
              ...
              <div class="d-flex justify-content-between">
               <input type="submit" name="add" class="btn btn-sm btn-info  mr-4 " value="Update">
                <a href="specialist.php" class="btn btn-sm btn-default float-right">Back</a>
              </div>
            </div>
    ...
    if(isset($_POST['add']))
    {
      ...
      $sql = mysqli_query($con,"UPDATE `specialist` SET `Specialties`='$Special',`Experties`='$Experties' WHERE sid='$sid'") or die(mysqli_error($con));
      if($sql == true)
      {
        echo'
        <script>
